 ...
 * category pills so the filter reads the same colour the map card's chip wears. Deliberately reuses
 * the structural kind hues (package blue, module teal, config amber) rather than minting new ones.
 */
...
export const CATEGORY_COLORS: Record<ModuleCategory, string> = {
  ...
  config: "#E0A33E", // amber — configuration/constants/types
