...
const KIND_COLORS: Record<string, string> = {
  ...
  external: "#6E7681",
  unresolved: "#565E68",
  // IPC: a channel is the shared wire two processes meet on (gold, like its edges); a system
  // frame is one linked artifact — steel blue, structural rather than behavioural.
  channel: "#C9A24B",
  system: "#8FB6E3",
};
