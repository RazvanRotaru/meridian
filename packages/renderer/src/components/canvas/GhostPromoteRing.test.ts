...
describe("ghost promotion", () => {
  it("keeps exact ghosts and real persistent parents, but excludes synthetic groups", () => {
    ...
    expect(promotableGhostNodes([core, synthetic, parent, exact])).toEqual([parent, exact]);
