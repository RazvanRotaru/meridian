/**
 * The IPC wire inspector — opens (top-right) when a magenta IPC wire is clicked, listing the channel(s)
  ...
  return (
    <aside style={PANEL} aria-label="IPC channel inspector">
      ...
      <div style={ROUTE}>
        ...
        <span style={{ color: IPC_ACCENT, flexShrink: 0 }}>→</span>
...
const KICKER: React.CSSProperties = { fontSize: 10.5, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: IPC_ACCENT };
...
const PROTO_TAG: React.CSSProperties = { flexShrink: 0, fontSize: 8.5, fontWeight: 700, letterSpacing: "0.05em", color: IPC_ACCENT, border: `1px solid ${IPC_ACCENT}66`, borderRadius: 3, padding: "1px 4px" };
