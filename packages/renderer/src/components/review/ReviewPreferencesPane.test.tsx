...
function render(flowView: ReviewFlowSplitView) {
  return renderToStaticMarkup(
    <ReviewPreferencesPane flowView={flowView} onFlowViewChange={() => undefined} onClose={() => undefined} />,
  );
}
...
describe("ReviewPreferencesPane", () => {
  it("renders an accessible native radio group and browser-scoped guidance", () => {
    ...
    expect(markup).toContain("Logic flow split view");
    ...
    expect(markup).toContain("only the PR review split view");
