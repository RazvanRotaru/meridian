 ...
 * which code), offers the opt-in "Extract head graph", and Reset (ticks only — never drafts)
 ...
 * sync mode reviews the boot (base-branch) graph with head-fetched code; after the opt-in extract
